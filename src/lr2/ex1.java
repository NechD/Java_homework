...
//Ищем минимальное число. Сначала считаем, что наим - первый элемент массива, проходимся по всем массиву, если находим число меньше - меняем наим. элемент на найденный
